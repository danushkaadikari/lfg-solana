...
const LFGSOL = () => {
  ...
  return (
    <article className="w-full flex flex-col justify-center items-start p-8 bg-black bg-opacity-30 rounded-[30px] max-md:px-5 max-md:max-w-full mb-4">
